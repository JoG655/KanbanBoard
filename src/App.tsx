...
function App() {
  ...
  return (
    <>
      <Navigation />
      <main className="flex flex-grow animate-fadeIn flex-col items-center scroll-smooth bg-primary-50 text-primary-800 dark:bg-primary-900 dark:text-primary-50">
